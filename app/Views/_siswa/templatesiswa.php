            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-white " href="/Biodata">
                        ...
                        <span class="sidenav-normal  ms-3  ps-1">Biodata</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link text-white " href="/DataUniversitas">
                        <i class="material-icons">business</i>
                        <span class="sidenav-normal  ms-3  ps-1">Data Universitas</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white " href="/Prestasi">
                        <i class="material-icons">school</i>
                        <span class="sidenav-normal  ms-3  ps-1">Prestasi</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white " href="/UploadDokumen">
                        <i class="material-icons">folder</i>
                        <span class="sidenav-normal  ms-3  ps-1">Upload Dokumen</span>
                    </a>
                </li>
                <li class="nav-item">
